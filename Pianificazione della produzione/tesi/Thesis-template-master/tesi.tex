...
\usepackage{xurl}                       %caporiga su url
...
\usepackage[table]{xcolor}              % colore di sfondo per le celle
...
\input{capitoli/Glossario}             % Product Prototype
